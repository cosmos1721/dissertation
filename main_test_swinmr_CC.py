...
def main(json_path):
    json_path = '/content/dissertation/options/SwinMR/example/test/test_swinmr_CCpi_G1D30.json'
...
if __name__ == '__main__':
    ...
    main(json_path='/content/dissertation/options/SwinMR/example/test/test_swinmr_CCpi_G1D30.json')
